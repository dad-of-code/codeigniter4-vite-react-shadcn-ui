  ...
  return (
    <div
      className={`w-full rounded-lg border px-4 py-3 text-xs ${
        enabled
          ? "border-emerald-800 bg-emerald-500/20 text-emerald-500 dark:bg-emerald-950/50"
          : "border-amber-700 bg-amber-500/20 text-amber-500 dark:bg-amber-950/50"
      }`}
    >
      ...
      {!enabled && (
        <div className="mt-2 space-y-1 text-amber-700/90 dark:text-amber-500/80">
          ...
          <ol className="list-inside list-decimal space-y-0.5 pl-1 font-mono text-[11px]">
            <li>
              ...
              <code className="rounded bg-amber-900/40 px-1">.env</code>
            </li>
            <li>
              Run:{" "}
      ...
      {enabled && (
        <div className="mt-2 space-y-1 text-emerald-700/90 dark:text-emerald-500/80">
          <p>
            Shield authentication is active. Protected assets require login.
          </p>
          <p>To get started with user management, run:</p>
          <code className="rounded bg-emerald-900/40 px-1 font-mono text-[11px]">
    ...
    <div className="flex min-h-svh flex-col items-center justify-center p-6">
      <div className="flex w-full max-w-xl flex-col items-center gap-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          <Button asChild>
            <Link to="/demo/layouts">Layouts Demo</Link>
          </Button>
        ...
        <p className="text-center text-xs text-muted-foreground/60">
          ...
          <br />
          Press{" "}
          <kbd className="rounded border px-1 font-mono text-[10px]">d</kbd> to
          toggle dark mode.
        </p>
      </div>
    </div>
